...
This script is used to create classifying data using differences features

Output file format
Short form
<jpeg*5*16, gaussian*5*4, rotation*5*8, scale*5*10>,label
...
parser.add_argument('--input_real', default ='dataset/real_train.csv')
parser.add_argument('--input_advml', default ='dataset/advml_train.csv')
parser.add_argument('--output_short', type=str, default='dataset/classifying_train.csv')
parser.add_argument('--output_full', type=str, default='dataset/classifying_train_detail.csv')
     ...
     with open(input_path) as csv_file:
        ...
        for row in csv_reader:
            ...
            for item in jpeg:
                ...
                txt_short.write('%d,%d,%d,%d,%d,' %(diff[0], diff[1], diff[2], diff[3], diff[4]))
                txt_full.write('%d,%d,%d,%d,%d,' %(diff[0], diff[1], diff[2], diff[3], diff[4]))
