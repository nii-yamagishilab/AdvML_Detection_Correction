...
This script is for training the CNN detector using counting features
"""
...
parser.add_argument('--train_set', default ='classifying_count_train.csv', help='train set')
parser.add_argument('--val_set', default ='classifying_count_val.csv', help='validation set')
# parser.add_argument('--train_set', default ='classifying_count_train_targeted.csv', help='train set')
# parser.add_argument('--val_set', default ='classifying_count_val_targeted.csv', help='validation set')
# parser.add_argument('--train_set', default ='classifying_count_train_nontargeted.csv', help='train set')
# parser.add_argument('--val_set', default ='classifying_count_val_nontargeted.csv', help='validation set')
