...
This script is for testing the CNN detector using differences features
"""
...
parser.add_argument('--test_set', default ='classifying_test.csv', help='test set')
# parser.add_argument('--test_set', default ='classifying_test_targeted.csv', help='test set')
# parser.add_argument('--test_set', default ='classifying_test_nontargeted.csv', help='test set')
