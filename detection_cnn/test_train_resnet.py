...
Script for testing trained ResNet50
"""
...
parser.add_argument('--outf', default='chkpt_train_resnet', help='folder to output model checkpoints')
parser.add_argument('--id', type=int, default=3, help='checkpoint ID')
# parser.add_argument('--outf', default='chkpt_train_resnet_targeted', help='folder to output model checkpoints')
# parser.add_argument('--id', type=int, default=16, help='checkpoint ID')
# parser.add_argument('--outf', default='chkpt_train_resnet_nontargeted', help='folder to output model checkpoints')
# parser.add_argument('--id', type=int, default=104, help='checkpoint ID')
...
if __name__ == '__main__':
    ...
    resnet.load_state_dict(torch.load(os.path.join(opt.outf,'resnet_' + str(opt.id) + '.pt')))
    resnet.eval()
